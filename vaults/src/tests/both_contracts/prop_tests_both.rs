...
use crate::tests::test_utils_runtime_verification::{create_base_data_vaults, setup_vaults, setup_liquidity_pools, create_test_data_liquidity, TestDataLiquidity};
...
fn usdx_low_solvent_liquidity() {
    ...
    let stable_depositors = [actor_5.clone(), actor_6.clone(), actor_7.clone(), actor_8.clone()];
    ...
    assert_eq!(original_usdc, data_stable.usdc_token_client.balance(actor_5));
    assert_eq!(original_usdx, data_stable.usdx_token_client.balance(actor_5));
    data_stable.usdc_token_client.burn(actor_5, &900_0000000);
    data_stable.usdx_token_admin_client.mint(actor_5, &1000_0000000);
    assert_eq!( 8100_0000000, data_stable.usdc_token_client.balance(actor_5));
    assert_eq!(10000_0000000, data_stable.usdx_token_client.balance(actor_5));

    // 2. Actor 5 swaps 1000 USDx for 1000 - ceil(1000 * 30_000 / 10_000_000) USDc 
    assert_eq!(4000_0000000, data_stable.usdc_token_client.balance(&data_stable.stable_liquidity_pool_contract_client.address));
    assert_eq!(4000_0000000, data_stable.usdx_token_client.balance(&data_stable.stable_liquidity_pool_contract_client.address));
    ...
    assert_eq!(3003_0000000, data_stable.usdc_token_client.balance(&data_stable.stable_liquidity_pool_contract_client.address));
    assert_eq!(4998_5000000, data_stable.usdx_token_client.balance(&data_stable.stable_liquidity_pool_contract_client.address));
    ...
    assert_eq!(97_0000000, data_stable.usdc_token_client.balance(actor_5) - original_usdc);
    assert_eq!(0, original_usdx - data_stable.usdx_token_client.balance(actor_5));
}
...
fn usdx_low_solvent_no_liquidity() {
    ...
    let cannot_redeem = data.contract_client
...
fn usdx_high_solvent_liquidity() {
    ...
    assert_eq!(5001_5045135, data_stable.usdc_token_client.balance(&data_stable.stable_liquidity_pool_contract_client.address));
    assert_eq!(3000_0000000, data_stable.usdx_token_client.balance(&data_stable.stable_liquidity_pool_contract_client.address));
    assert_eq!(7996_9909729, data_stable.usdc_token_client.balance(actor_5));
    assert_eq!(10000_0000000, data_stable.usdx_token_client.balance(actor_5));
    assert_eq!(1_5045136, data_stable.usdc_token_client.balance(&data_stable.treasury));


    // 2. Actor 5 trades 1000 USDx for 1100 USDc (simulated)
    data_stable.usdx_token_client.burn(actor_5, &1000_0000000);
    data_stable.usdc_token_admin_client.mint(actor_5, &1100_0000000);
    assert_eq!( 9096_9909729, data_stable.usdc_token_client.balance(actor_5));
    assert_eq!(original_usdx, data_stable.usdx_token_client.balance(actor_5));


    // 3. Actor 5 profits 1100 - (1000 + fee)  
    assert_eq!(96_9909729, data_stable.usdc_token_client.balance(actor_5) - original_usdc);
    assert_eq!(0, original_usdx - data_stable.usdx_token_client.balance(actor_5));
}
...
fn usdx_high_solvent_no_liquidity() {
    ...
    data.collateral_token_admin_client.mint(actor_5, &(*req_xlm as i128));
    assert_eq!(0, data_stable.usdx_token_client.balance(actor_5));
    assert_eq!(0, data_stable.usdc_token_client.balance(actor_5));
    assert_eq!(12_558_3094594, data.collateral_token_client.balance(actor_5));

    data.contract_client.new_vault(&OptionalVaultKey::None, actor_5, &1000_0000000, req_xlm, &symbol_short!("usd"));
